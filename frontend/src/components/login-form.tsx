...
import type { authResponseSchema } from "@/schema/authResponse";
...
export function LoginForm({
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data: z.infer<typeof authResponseSchema>) => {
      ...
      <FieldGroup>
        ...
        <Field>
          <Button
            ...
            type="button"
            onClick={() =>
              (window.location.href = `${import.meta.env.VITE_BASE_URL || "http://localhost:8080"}/oauth2/authorization/google`)
            }
          >
            <svg
